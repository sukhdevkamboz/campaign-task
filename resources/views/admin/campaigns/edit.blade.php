<x-admin-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Edit Campaign Details</h2>
                <p class="text-gray-500 mt-1">Update information for {{ $campaign->name }}.</p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form class="p-6 space-y-6" method="POST" action="{{ route('contact-fields.store') }}">
                @csrf
                        ...
                        @foreach($fields as $key=>$field)
                                ...
                                <div class="mt-4 dynamic-field">
                                    ...
                                    @if($type == 'textarea') 
                                        ...
                                        <textarea name="dynamic_fields[$key]" class="w-full px-4 py-2 border border-gray-300 rounded-lg">{{ $value }}</textarea>

                                    @else
                                        <input type="'+type+'" name="dynamic_fields[$key]" value="{{ $value }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg" />

<x-admin-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Create New Email Template</h2>
                <p class="text-gray-500 mt-1">Add a new email template to the system.</p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <form id="formTemplate" method="POST" action="{{ route('email-templates.store') }}" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input id="template_variable" type="text" name="template_variable" value="{{ old('template_variable') }}" required autofocus 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200"
                ...
                <!-- Name -->
                <div>
                    <label for="editor" class="block text-sm font-medium text-gray-700 mb-1">Body</label>
                    <textarea id="editor" type="text" name="body" value="{{ old('body') }}" required autofocus 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200"
